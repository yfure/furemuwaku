...
class EventListenerProvider implements ListenerProviderInterface
{
	 ...
	 * @access Public
	 *
	 * @params string   $eventName The name of the event to attach the listener to.
	 * @params Closure $listener  The listener to attach to the event.
	 *
	 * @return void
	 */
	 ...
	 * @access Public
	 *
	 * @params object $event The event to retrieve listeners for.
	 *
	 * @return iterable An iterable collection of Closures( listeners ).
	 */
